...
<body>
  ...
  <div class="text-center" id="brandName">
    <a class="navbar-brand" href="index.php" id="logo">
      ...
      <h1 class="titlePac">Resultados para <?php echo $_GET['texto'];?> </h1>
      <hr class="style-one">
    </a>
  </div>
  ...
  <nav class="navbar navbar-expand-lg sticky-top navShadow wow fadeIn">
    ...
    <div class="collapse navbar-collapse" id="pageNav">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#">TODAS LAS OBRAS
...
<?php
  include('./php/conexion.php');
  $resultado = $conexion ->query("select * from cuadros where nombre like '%".$_GET['texto']."%' or info like '%".$_GET['texto']."%' ")or die($conexion -> error);
